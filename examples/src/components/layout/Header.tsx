                ...
                <div className="flex h-14 items-center justify-between gap-8 px-4 sm:px-6">
                    <div className="flex items-center gap-4">
                        <h1 className="font-mono text-gray-950 dark:text-white">
                            BaseStacks <span className="font-bold">package-template</span>
                        </h1>
                    ...
                    <div className="flex items-center gap-6 max-md:hidden">
                        {headerMenu.map((item, index) => {
                            if (item.href) {
                                return (
                                    <a key={index} href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub repository" >
                                        <item.icon className="size-5 fill-black/40 dark:fill-gray-400" /> {item.title}
                                    </a>
                                );
                            }
